...
{
    /// <inheritdoc />
    public partial class init_models_with_identity : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Post_Status", "[Status] IN ('Draft', 'PendingApproval', 'Approved', 'Rejected')");
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_Post_AspNetUsers_ReviewedByAdminId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Post_ReviewedByAdminId",
                table: "Post",
